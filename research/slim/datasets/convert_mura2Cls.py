...
_NUM_SHARDS = 2
_RANDOM_SEED = 0
# _NUM_VALIDATION = 350         #train 1617 val 370
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'maskCls_%s_%05d-of-%05d.tfrecord' % (split_name, shard_id, _NUM_SHARDS)
...
def run(dataset_dir, val_or_train):
  ...
  print('\n Finished converting the maskCls dataset')